...
export const GET: RequestHandler = async (event) => {
	...
	try {
		...
		const loadSheetImage = async (url: string): Promise<number | null> => {
			try {
		...
		const gcLogoId = await loadSheetImage('https://res.cloudinary.com/dqvhbvqnw/image/upload/v1779339673/GC_LOGO_p0cj6w.png');
		const chtmSealId = await loadSheetImage('https://res.cloudinary.com/dqvhbvqnw/image/upload/v1775488521/CHTM_LOGO_zkdl8h.png');
		const chtmCooksLogoId = await loadSheetImage('https://res.cloudinary.com/dqvhbvqnw/image/upload/v1779339673/CHTM-COOKS_LOGO_rgmfs4.png');
