...
const damageRateDisplay = $derived.by(() => {
	...
	function getRequestDeepLink(r: BorrowRequestRecord): string {
		...
		return `/auditor/requests?${params.toString()}`;
	}
...
<svelte:head><title>Dashboard - Auditor</title></svelte:head>
...
<div class="space-y-6">
	...
	{:else}
		...
		<div class="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-4">
			...
			<button
				type="button"
				onclick={() => goto('/auditor/requests?tab=active')}
			...
			<button
				type="button"
				onclick={() => goto('/auditor/requests?tab=pending')}
			...
			<button
				type="button"
				onclick={() => goto('/auditor/requests?tab=active&filter=overdue')}
	...
	{/if}
		...
		<div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
			<div class="flex items-center justify-between border-b border-gray-100 px-5 py-4">
				...
				<a href="/auditor/requests" class="flex items-center gap-1 text-xs font-medium text-pink-600 hover:text-pink-700">
		...
		{:else}
			...
			<div class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-100">
				<div class="mb-4 flex items-center justify-between">
					...
					<a href="/auditor/analytics?tab=inventory" class="flex items-center gap-1 text-xs font-medium text-pink-600 hover:text-pink-700">
			...
			<div class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-100">
				<div class="mb-4 flex items-center justify-between">
					...
					<a href="/auditor/analytics?tab=students" class="flex items-center gap-1 text-xs font-medium text-pink-600 hover:text-pink-700">
		...
		{:else}
			...
			<div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
				<div class="flex items-center justify-between border-b border-gray-100 px-5 py-4">
					...
					<a href="/auditor/analytics" class="flex items-center gap-1 text-xs font-medium text-pink-600 hover:text-pink-700">
						Full report <ArrowRight size={13} />
					</a>
				</div>
