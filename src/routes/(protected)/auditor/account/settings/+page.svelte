...
<div class="space-y-6 pb-8">
	...
	<div class="space-y-4">
		...
		<div class="rounded-lg bg-white shadow">
			...
			{#if privacyOpen}
				<div class="px-6 py-5 text-sm text-gray-600 space-y-5">
					<p class="text-xs text-gray-400 uppercase tracking-wide font-semibold">Last Updated: February 2026 &nbsp;·&nbsp; Compliant with RA 10173 (Philippine DPA)</p>
		...
		<div class="rounded-lg bg-white shadow">
			...
			{#if termsOpen}
				<div class="px-6 py-5 text-sm text-gray-600 space-y-5">
					<p class="text-xs text-gray-400 uppercase tracking-wide font-semibold">Last Updated: February 2026 &nbsp;·&nbsp; College Regulations &amp; Borrowing Policies</p>
