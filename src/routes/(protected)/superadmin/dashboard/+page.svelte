<script lang="ts">
	...
	function syncInventoryAlertCounts(summary: AnalyticsReport['inventory']['summary'] | null | undefined): void {
		const outOfStockCount = summary?.outOfStockCount ?? 0;
		const lowStockCount = summary?.lowStockCount ?? 0;

		lowStockItems = Math.max(0, lowStockCount - outOfStockCount);
	...
	if (initialReport) {
		syncInventoryAlertCounts(initialReport.inventory.summary);
	}
	...
	async function loadDashboardData(showLoader = true, forceRefresh = true) {
		...
		try {
			...
			if (analyticsRes.status === 'fulfilled') {
				...
				syncInventoryAlertCounts(analyticsRes.value.inventory.summary);
			}
			cardsLoading = false;
	...
	{:else}
		...
		<div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
			<button
				...
				class="w-full text-left rounded-xl border border-purple-200 bg-purple-50 p-3 shadow-sm transition-all duration-200 hover:shadow-md active:scale-98 focus:outline-none focus:ring-2 focus:ring-purple-500/20 cursor-pointer sm:p-5"
			>
			...
			<button
				type="button"
				onclick={() => goto('/superadmin/class-codes')}
				class="w-full text-left rounded-xl border border-pink-200 bg-pink-50 p-3 shadow-sm transition-all duration-200 hover:shadow-md active:scale-98 focus:outline-none focus:ring-2 focus:ring-pink-500/20 cursor-pointer sm:p-5"
			>
				<div class="flex items-center justify-between gap-2">
					<div class="min-w-0">
			...
			<button
				type="button"
				onclick={() => goto('/superadmin/requests')}
				class="w-full text-left rounded-xl border border-blue-200 bg-blue-50 p-3 shadow-sm transition-all duration-200 hover:shadow-md active:scale-98 focus:outline-none focus:ring-2 focus:ring-blue-500/20 cursor-pointer sm:p-5"
			>
				<div class="flex items-center justify-between gap-2">
					<div class="min-w-0">
			...
			<button
				type="button"
				onclick={() => goto('/superadmin/inventory')}
				class="w-full text-left rounded-xl border border-emerald-200 bg-emerald-50 p-3 shadow-sm transition-all duration-200 hover:shadow-md active:scale-98 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 cursor-pointer sm:p-5"
			>
				<div class="flex items-center justify-between gap-2">
					<div class="min-w-0">
		...
		<div class="grid grid-cols-2 gap-3 lg:grid-cols-4">
			<button
				...
				class="w-full text-left rounded-xl border border-yellow-200 bg-yellow-50 p-3 shadow-sm transition-all duration-200 hover:shadow-md active:scale-98 focus:outline-none focus:ring-2 focus:ring-yellow-500/20 cursor-pointer sm:p-5"
			>
				<div class="flex items-center justify-between gap-2">
					<div class="min-w-0">
			...
			<button
				type="button"
				onclick={() => goto('/superadmin/requests?filter=overdue')}
				class="w-full text-left rounded-xl border border-red-200 bg-red-50 p-3 shadow-sm transition-all duration-200 hover:shadow-md active:scale-98 focus:outline-none focus:ring-2 focus:ring-red-500/20 cursor-pointer sm:p-5"
			>
				<div class="flex items-center justify-between gap-2">
					<div class="min-w-0">
