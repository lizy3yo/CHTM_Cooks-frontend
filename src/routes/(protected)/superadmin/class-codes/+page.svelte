	...
	{#if activeTab === 'all'}
		...
		<div class="grid grid-cols-2 gap-3 lg:grid-cols-4">
			...
			<button
				...
				{(!selectedSemester && !selectedYear && !searchQuery) ? 'border border-gray-300 bg-gray-50/50 ring-1 ring-gray-200 shadow-md' : 'bg-white border border-transparent hover:shadow-md hover:border-gray-200/50 hover:bg-gray-50/50'}"
			>
			...
			<button
				type="button"
				onclick={() => goto('/superadmin/users?role=student')}
				class="w-full text-left rounded-lg p-3 bg-white border border-transparent shadow hover:shadow-md hover:border-pink-200/50 hover:bg-gray-50/50 transition-all duration-200 active:scale-98 focus:outline-none focus:ring-2 focus:ring-pink-500/20 cursor-pointer sm:p-5"
			>
				<div class="flex items-center justify-between gap-2">
					<div class="min-w-0">
			...
			<button
				...
				class="w-full text-left rounded-lg p-3 bg-white border border-transparent shadow hover:shadow-md hover:border-purple-200/50 hover:bg-gray-50/50 transition-all duration-200 active:scale-98 focus:outline-none focus:ring-2 focus:ring-purple-500/20 cursor-pointer sm:p-5"
			>
				<div class="flex items-center justify-between gap-2">
					<div class="min-w-0">
						<p class="truncate text-xs font-medium text-gray-600 sm:text-sm">Average Class Size</p>
			...
			<button
				type="button"
				onclick={() => goto('/superadmin/users?role=instructor')}
				class="w-full text-left rounded-lg p-3 bg-white border border-transparent shadow hover:shadow-md hover:border-blue-200/50 hover:bg-gray-50/50 transition-all duration-200 active:scale-98 focus:outline-none focus:ring-2 focus:ring-blue-500/20 cursor-pointer sm:p-5"
			>
				<div class="flex items-center justify-between gap-2">
					<div class="min-w-0">
						<p class="truncate text-xs font-medium text-gray-600 sm:text-sm">Assigned Instructors</p>
