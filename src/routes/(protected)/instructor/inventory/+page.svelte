			...
			for (let i = headerLineIndex + 1; i < lines.length; i++) {
				...
				if (pictureRef) {
					...
					// Check if it matches an uploaded image file
						...
						hasImage = true;
						imageSource = (pictureRef.toLowerCase().startsWith('excel_row_') || pictureRef.toLowerCase().startsWith('excel_name_')) ? 'excel' : 'zip';
					}
							...
							<div class="px-4 py-3 sm:px-6 sm:py-4 lg:px-8 lg:py-5">
								<div class="flex items-center justify-between gap-3">
									...
									{#if status === 'Out of Stock'}
										<div class="flex min-w-0 flex-1 items-center gap-2 rounded-xl px-3 py-2 ring-1 bg-red-50 ring-red-200 text-red-700">
			...
			<div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4" data-tour="instructor-inventory-stats">
				...
				<button type="button" onclick={() => { stockModalMode = 'available'; showStockModal = true; }} class="w-full rounded-lg border border-gray-200 bg-white p-3 shadow-sm transition-all duration-200 hover:border-pink-300 hover:shadow-md active:scale-98 cursor-pointer text-left focus:outline-none focus:ring-2 focus:ring-pink-500/20 sm:p-5">
					<div class="flex items-center justify-between gap-2">
						...
						<div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-pink-100 text-pink-600 sm:h-12 sm:w-12">
							<svg class="h-5 w-5 text-pink-600 sm:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
							</svg>
							<svg class="hidden h-6 w-6 text-pink-600 sm:block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
							</svg>
						</div>
					</div>
				...
				<!-- Card 3: Out / Released -->
				<button type="button" onclick={() => (showReleasedModal = true)} class="w-full rounded-lg border border-gray-200 bg-white p-3 shadow-sm transition-all duration-200 hover:border-pink-300 hover:shadow-md active:scale-98 cursor-pointer text-left focus:outline-none focus:ring-2 focus:ring-pink-500/20 sm:p-5">
					<div class="flex items-center justify-between gap-2">
						<div class="min-w-0">
