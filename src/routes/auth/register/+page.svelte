								...
								<label class="flex items-start">
									...
									<span class="ml-3 text-sm text-gray-600">
										...
										<a
											...
											target="_blank"
											rel="noopener noreferrer"
											class="font-medium text-pink-600 hover:text-pink-500 underline mr-2"
										>
											Privacy Policy
										</a>
										<!-- Direct links to canonical pages (open in new tab) -->
										<a href="/terms" target="_blank" rel="noopener noreferrer" class="text-xs text-gray-500 ml-2">(View full)</a>
										<a href="/privacy" target="_blank" rel="noopener noreferrer" class="text-xs text-gray-500 ml-2">(View full)</a>
			...
			<div class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all w-full max-w-3xl z-10">
				<div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
					...
					<div class="mt-4 max-h-96 overflow-y-auto prose prose-sm max-w-none">
						<p class="text-sm text-gray-500 mb-4">Last updated: May 24, 2026</p>
