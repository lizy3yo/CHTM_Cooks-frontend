			...
			<div class="relative" data-topnav-dropdown>
				...
				{#if profileOpen}
					...
					>
						...
						<a href="/instructor/account/activity-logs" onclick={() => profileOpen = false} role="menuitem" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-pink-50 hover:text-pink-600">
